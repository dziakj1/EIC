...
the.data <- read.table("allanswers.csv",
                       header=TRUE,
                       sep=",",
                       na.strings=".",
                       fill=TRUE);
the.cps <- read.table("allanswers.csv",
                       header=TRUE,
                       sep=",",
                       na.strings=".",
                       fill=TRUE);
...
true.power.x1.data$predicted <- 1-pf(qf(.95,1,true.power.x1.data$num.clusters-17),
                                     1,
                                     true.power.x1.data$num.clusters-17,
...
print(true.power.x1.data[order(true.power.x1.data$fractional,
                               ...
                               c("d","fractional","n","cluster.size","icc","power","predicted")]);
